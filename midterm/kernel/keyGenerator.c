...
static int key_generator_init(void)
{
    ...
    //answer: when this kernel module is inserted to kernel using insmod, module_init() will call this function
    int result = 0;
...
static void key_generator_exit(void)
{
    ...
    //answer: when this kernel module is removed/unloaded from kernel using rmmod, module_exit() will call this function
...
int register_device(void)
{
    ...
    //answer: result, because register_chrdev returns major number of the device
